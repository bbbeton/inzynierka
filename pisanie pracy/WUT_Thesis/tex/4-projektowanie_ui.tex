...
\section{Projekt interfejsu użytkownika}
    ...
    \subsection{Nawigacja i główne ekrany aplikacji}
        ...
        \subsubsection{Ekran mapy (\textit{Spot Map})}
            ...
            \begin{figure}[!h]
                \centering \includegraphics[width=0.3\linewidth]{Frame7.png}
        ...
        \subsubsection{Ekran wykrywania trików (\textit{Detect Trick})}
            ...
            \begin{figure}[!h]
                \centering \includegraphics[width=0.3\linewidth]{KAMERA.png}
            ...
            \begin{figure}[!h]
                \centering \includegraphics[width=0.3\linewidth]{historia.png}
